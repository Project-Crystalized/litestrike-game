...
for row in res.fetchall():
    ...
    if was_winner:
        print("They were part of the winning team")
    else:
        print("They were part of the loosing team")
...
print(f"total money spent: {total_money_spent}$ which is {total_money_spent/number_of_rounds:.2f} $/round, or {total_money_spent/number_of_player:.2f} $/player on avarage")
print(f"total assists: {total_assists} which is {total_assists/number_of_rounds:.2f} assists/round, or {total_assists/number_of_player:.2f} assists/player")
print(f"total kills: {total_kills} which is {total_kills/number_of_rounds:.2f} kills/round, or {total_kills/number_of_player:.2f} kills/player")
print(f"total damage dealt {total_damage} which is {total_damage/number_of_rounds:.2f} damage/round, or {total_damage/number_of_player:.2f} damage/player")
