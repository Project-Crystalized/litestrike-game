...
public class LSItem {
	...
	public static List<LSItem> createItems() {
		...
		LSItem ironChestplate = new LSItem(new ItemStack(Material.IRON_CHESTPLATE), new ItemStack(Material.IRON_CHESTPLATE),
				250, null, ItemCategory.Armor);
		LSItem crossbow = new LSItem(new ItemStack(Material.CROSSBOW), new ItemStack(Material.CROSSBOW), 1000, null,
				ItemCategory.Range);
